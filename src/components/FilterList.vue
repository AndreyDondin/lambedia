<template>
  <div class="filter">
    ...
    <input
      ...
      v-model="input"
      @input="filterUser($event.target.value.toLowerCase())"
    />
...
export default defineComponent({
  emits: ['update:input'],
  setup() {
    const { filterUser, users, sort, activeSorting } = useFilter();
    ...
    return { filterUser, resetSort, input, activeSorting };
  },
});
</script>
